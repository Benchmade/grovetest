package org.grove.common.bloomfilter;
 ...
 */
public class BloomFilter2<E> implements Serializable {
    ...
    /**
      ...
      */
    public BloomFilter2(double c, int n, int k) {
     ...
     */
    public BloomFilter2(int bitSetSize, int expectedNumberOElements) {
     ...
     */
    public BloomFilter2(double falsePositiveProbability, int expectedNumberOfElements) {
     ...
     */
    public BloomFilter2(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements, BitSet filterData) {
    ...
    public boolean equals(Object obj) {
        ...
        final BloomFilter2<E> other = (BloomFilter2<E>) obj;        
