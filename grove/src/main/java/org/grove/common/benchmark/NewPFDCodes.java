...
public class NewPFDCodes {
	...
	private static int[] basicMask = new int[] { 0, 1, (1 << 2) - 1, (1 << 3) - 1, (1 << 4) - 1, (1 << 5) - 1, (1 << 6) - 1, (1 << 7) - 1,
			(1 << 8) - 1, (1 << 9) - 1, (1 << 10) - 1, (1 << 11) - 1, (1 << 12) - 1, (1 << 13) - 1, (1 << 14) - 1, (1 << 15) - 1,
			(1 << 16) - 1, (1 << 17) - 1, (1 << 18) - 1, (1 << 19) - 1, (1 << 20) - 1, (1 << 21) - 1, (1 << 22) - 1, (1 << 23) - 1,
			(1 << 24) - 1, (1 << 25) - 1, (1 << 26) - 1, (1 << 27) - 1, (1 << 28) - 1, (1 << 29) - 1, (1 << 30) - 1, (1 << 31) - 1,
			(1 << 32) - 1
	...
	private void encodeCompressedValue(int i, int val, int b, int[] frame) {
		...
		frame[intPos + headerSize] = frame[intPos + headerSize] & mask | _val;
		...
		if (32 < endBit) {
			...
			_val = val >>> shiftBit;
			frame[intPos + headerSize + 1] = frame[intPos + headerSize + 1] & mask | _val;
		}
	 ...
	 * @return
	 */
	private int makeHeader(int b, int firstExceptionPos, int[] code, int exceptionNum, int exceptionIntRange, boolean lastFlag) {

		int dataNum = code.length - 1;
		int lastOrNot = lastFlag ? 1 : 0;
		return dataNum << 25 | firstExceptionPos << 17 | (b - 1) << 12 | exceptionIntRange << 1 | lastOrNot;
	...
	private int[] optimizedCompressBits(int[] numbers, int offset, int length) {
		...
		if (maxValue <= 1)
			return new int[] { 1, 0 }; // bitFrame, exceptionNum, exceptionCode :
	...
	private int[] fastDecodeFrame(int headerPos, int[] encodedValue, int decodeOffset, int[] decode, boolean useGapList) {
		...
		switch (numFrameBit) {
		case 1:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor1Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 2:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor2Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 3:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor3Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 4:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor4Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 5:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor5Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 6:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor6Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 7:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor7Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 8:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor8Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 9:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor9Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 10:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor10Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 11:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor11Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 12:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor12Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 13:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor13Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 14:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor14Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 15:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor15Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 16:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor16Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 17:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor17Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 18:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor18Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 19:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor19Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 20:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor20Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 21:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor21Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 22:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor22Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 23:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor23Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 24:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor24Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 25:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor25Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 26:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor26Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 27:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor27Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 28:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor28Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 29:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor29Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 30:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor30Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 31:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor31Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		case 32:
			intOffsetForExceptionRange = PForDecompress.fastDeCompressFor32Bit(encodeOffset, encodedValue, dataNum, decodeOffset, decode);
			break;
		default:
			throw new RuntimeException("numFramBit is too high ! " + numFrameBit);
		}
